...
#define IO_USERNAME  "mp_3333"
#define IO_KEY       "aio_Iopx90YjgBqU0sM4JQZWRkCOLPyL"
#define WIFI_SSID "krosha"
#define WIFI_PASS "krosha123"
...
void loop()
{
 ...
 if (abs(exteriorFTemp-setTempF)<3) {
  myservo.detach();
  digitalWrite(ledRed,LOW);
